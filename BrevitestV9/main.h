...
#define BUFFER_PACKET_NUMBER_LENGTH 3
...
#define BUFFER_ID_LENGTH 7
#define BUFFER_PAYLOAD_INDEX (BUFFER_ID_INDEX + BUFFER_ID_LENGTH)
#define BUFFER_PAYLOAD_MAX_LENGTH (PARTICLE_ARG_SIZE - BUFFER_PAYLOAD_INDEX)
#define BUFFER_MESSAGE_SIZE_INDEX BUFFER_PAYLOAD_INDEX
#define BUFFER_MESSAGE_SIZE_LENGTH 4
